...
public class PAppletProjectorNode extends Node{
	...
	{	
		...
		Sphere shpere = new Sphere(10,10,0.1f);
...
//	    projectorCamera.setLocation(Vector3f.ZERO);
...
//		this.attachChild(projectorGeometry);
	...
	public void setLocalTranslation(Vector3f location){
		...
		this.projector.getProjectorCamera().setLocation(location);	
	...
	public void lookAt(Vector3f destination, Vector3f up){
	    ...
	    this.projector.getProjectorCamera().lookAt(destination, up);    
