...
public class TestProjectorShadowParameter extends SimpleApplication {
	...
	public void simpleInitApp() {
        ...
        ppg = new PAppletProjectorShadowNode("Projector", viewPort, assetManager, 1024, 768, applet, 400,300,false);        
        rootNode.attachChild(ppg);        
		/*
		 * 
	     *  testing projector location and destination
	     *
	     */
	        //
	        // from top to bottom along Y-Axis
	        //
        	// ok
	        ...
	        /* bad...
	        ppg.setLocalTranslation(new Vector3f(0,10,0));		 // move the projector,
	        ppg.lookAt(new Vector3f(0,0,0), Vector3f.UNIT_Y);// and make it to look at where you want.	        
	        */	        
	        /* ok
	        ppg.setLocalTranslation(new Vector3f(0,10,0));		 // move the projector,
	        ppg.lookAt(new Vector3f(0,0,0), Vector3f.UNIT_Z);// and make it to look at where you want.	        
	        */
	        
	        //
	        // from floor to wall along X-Axis
	        //	        
	        /* bad...
	        ppg.setLocalTranslation(new Vector3f(3,0,0));		 // move the projector,
	        ppg.lookAt(new Vector3f(-3,0,0), Vector3f.UNIT_X);// and make it to look at where you want.
			*/
	        /* ok
	        ppg.setLocalTranslation(new Vector3f(3,0,0));		 // move the projector,
	        ppg.lookAt(new Vector3f(-3,0,0), Vector3f.UNIT_Y);// and make it to look at where you want.
			*/
	        /* ok
	        ppg.setLocalTranslation(new Vector3f(3,0,0));		 // move the projector,
	        ppg.lookAt(new Vector3f(-3,0,0), Vector3f.UNIT_Z);// and make it to look at where you want.
	        
	        //
	        // from floor to wall along Z-Axis
	        //
	        /* ok
	        ppg.setLocalTranslation(new Vector3f(0,0,3));		 // move the projector,
	        ppg.lookAt(new Vector3f(0,0,-3), Vector3f.UNIT_X);// and make it to look at where you want.
	        */	        
	        /* ok
	        ppg.setLocalTranslation(new Vector3f(0,0,3));		 // move the projector,
	        ppg.lookAt(new Vector3f(0,0,-3), Vector3f.UNIT_Y);// and make it to look at where you want.
	        */
	        /* bad...
	        ppg.setLocalTranslation(new Vector3f(0,0,3));		 // move the projector,
	        ppg.lookAt(new Vector3f(0,0,-3), Vector3f.UNIT_Z);// and make it to look at where you want.
	        */
	        	        
	        //
	        // from floor to corner along X-Axis and Z-Axis
	        //
	        /* ok
	        ppg.setLocalTranslation(new Vector3f(3,0,3));		 // move the projector,
	        ppg.lookAt(new Vector3f(-3, 0, -3), Vector3f.UNIT_X);// and make it to look at where you want.
	        */
	        /* ok
	        ppg.setLocalTranslation(new Vector3f(3,0,3));		 // move the projector,
	        ppg.lookAt(new Vector3f(-3, 0, -3), Vector3f.UNIT_Y);// and make it to look at where you want.
	        */
	        /* ok
	        ppg.setLocalTranslation(new Vector3f(3,0,3));		 // move the projector,
	        ppg.lookAt(new Vector3f(-3, 0, -3), Vector3f.UNIT_Z);// and make it to look at where you want.
	        */
	        
	        //
	        // from floor to wall along X-Axis and lookAt X-Axis and Z-Axis
	        //
	        /* bad... 
	        ppg.setLocalTranslation(new Vector3f(3,0,0));		 // move the projector,
	        ppg.lookAt(new Vector3f(-3, 0, -6), Vector3f.UNIT_Y);// and make it to look at where you want.
	        */	        
	        /* bad...
	        ppg.setLocalTranslation(new Vector3f(3,0,0));		 // move the projector,
	        ppg.lookAt(new Vector3f(-3, 9, 0), Vector3f.UNIT_Y);// and make it to look at where you want.
	        */			                
	}
	...
	public static void main(String[] args) {
		SimpleApplication app = new TestProjectorShadowParameter();
		app.start();
	}
}
