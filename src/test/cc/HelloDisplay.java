...
import test.p5.LoopMoviePApplet;
...
public class HelloDisplay extends SimpleApplication {
	...
	public void simpleInitApp() {
		...
		PApplet applet = new MikuFlipPApplet(250, "miku-front");
		...
		display0.setLocalTranslation(0, -1, 0);		
		
		PApplet applet1 = new MikuFlipPApplet(250, "miku-back");
