...
public class PendulumnCircleCollision extends PendulumPApplet {
...
//	    balls[i].x += vels[i].x;
//	    balls[i].y += vels[i].y;
		balls[i].x += vels[i].x + gravityS * Math.sin(-appletAngle);
		balls[i].y += vels[i].y + gravityS * Math.cos(-appletAngle);
