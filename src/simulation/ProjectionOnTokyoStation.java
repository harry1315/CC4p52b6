...
import test.p5.DynamicParticlesRetained;
...
public class ProjectionOnTokyoStation extends SimpleApplication {
	...
	public void simpleInitApp() {		
        ...
        cam.setLocation(new Vector3f(-200.0f,150.0f,-70.0f));
        ...
        ppsn = new PAppletProjectorShadowNode("Projector", viewPort, assetManager, 640, 480, applet, 640, 480, true);
		rootNode.attachChild(ppsn);	
		ppsn.setLocalTranslation(-200f, 1f, 0);
...
//	}
	...
	public static void main(String[] args) {
		SimpleApplication app = new ProjectionOnTokyoStation();
